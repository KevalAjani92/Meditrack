...
export default function TestsTable({ data, onViewDetail, onEdit }: TestsTableProps) {
  return (
          ...
          <tbody className="divide-y divide-border">
            {data.map((item) => (
              ...
              >
                ...
                <td className="px-6 py-4">
                  <Badge variant="outline" className="text-muted-foreground flex w-fit items-center gap-1.5">
