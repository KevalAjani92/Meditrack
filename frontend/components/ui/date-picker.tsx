            ...
            {isOpen && (
                <div className="absolute top-[calc(100%+4px)] left-0 z-50 w-[280px] rounded-md border bg-popover text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95 p-3">
                    ...
                    <div className="flex items-center justify-between mb-2">
                        <Button variant="ghost" size="icon" className="h-7 w-7 rounded-md" onClick={handlePrev}>
                        ...
                        <Button variant="ghost" size="icon" className="h-7 w-7 rounded-md" onClick={handleNext}>
                        ...
                        <div className="animate-in slide-in-from-left-2 duration-200">
                            ...
                            <div className="grid grid-cols-7 gap-1">
                                {daysArray.map((day, i) => {
                                    ...
                                    const isDisabled = disabled || (minDate && currentDateStr < minDate);
