...
export function LandingHeader() {
    ...
    const snowColor = mounted && resolvedTheme === "light" ? "#3b82f6" : "#ffffff";
                ...
                <div className="container mx-auto flex h-16 items-center justify-between px-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Button
                            ...
                            size="icon"
                            onClick={toggleSnow}
                            className={showSnow ? "text-primary bg-primary/10" : "text-muted-foreground"}
                            title="Toggle Snow"
                        >
                        ...
                        <nav className="flex flex-col gap-6 text-lg font-medium">
                            ...
                            <div className="flex flex-col gap-4 mt-4">
                                ...
                                <Link href="/auth/register" onClick={() => setIsMobileMenuOpen(false)}>
                                    <Button className="w-full text-lg h-12 shadow-md shadow-primary/20">Get Started</Button>
                                </Link>
                            </div>
                        </nav>
                    </motion.div>
