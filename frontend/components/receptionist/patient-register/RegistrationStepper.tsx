...
const steps = ["Basic Info", "Medical Details", "Emergency Contacts", "Summary"];

export default function RegistrationStepper({ currentStep }: Props) {
  return (
    <div className="w-full py-4 mb-8 p-4">
        ...
        {steps.map((step, index) => {
          ...
          return (
            <div key={step} className="relative z-10 flex flex-col items-center gap-2">
              ...
              <span className={`text-[11px] font-medium absolute -bottom-6 whitespace-nowrap ${
