...
export default function ProcedureTooltip({ children, description, treatmentType, department, date }: Props) {
  return (
        ...
        <Tooltip.Portal>
          ...
          >
            ...
            <div className="border-t border-border mt-2 pt-2 space-y-1">
              <p className="text-xs text-muted-foreground"><span className="font-semibold text-foreground">Treatment:</span> {treatmentType}</p>
